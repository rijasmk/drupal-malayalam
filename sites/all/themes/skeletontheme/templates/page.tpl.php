<div id="wrap">
    <div class="container white">
        ...
        <div id="header" class="sixteen columns clearfix">
            <div class="inner">
                ...
                <div class="one_half last">
                  <?php if ($page['logobar_right']): ?>
                    <div class="content">
                    <?php print render($page['logobar_right']); ?>
                    </div>
                  <?php endif; ?>
                </div>
            </div>
        ...
        <?php } ?>
            ...
            <?php if ($page['content_first'] || $page['content_second']): ?>
        ...
        <div id="footer" class="sixteen columns clearfix">
            ...
            <div id="credits">&copy; <?php print(date('Y') . ' ');?>
            <?php if (!empty($site_name)):?>
            <?php print $site_name;?>. All rights reserved.<br />
            <?php endif;?>            
            </div>
